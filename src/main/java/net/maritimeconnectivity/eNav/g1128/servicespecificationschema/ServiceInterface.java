 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="operation" type="{http://iala-aism.org/g1128/v1/ServiceSpecificationSchema.xsd}Operation" maxOccurs="unbounded"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="consumerInterface" type="{http://iala-aism.org/g1128/v1/ServiceSpecificationSchema.xsd}ConsumerInterface" minOccurs="0"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ServiceInterface {
    ...
    /**
     * Human readable service interface name. The name shall be no longer than one line.
     */
    @XmlElement(required = true)
    protected String name;
    /**
     * Human readable description of the service interface.
     */
    @XmlElement(required = true)
    protected String description;
    /**
     * Message exchange pattern for the entire interface. Message exchange pattern can be one of
     *  ONE_WAY,
     *  REQUEST_RESPONSE,
     *  REQUEST_CALLBACK,
     *  PUBLISH_SUBSCRIBE,
    ...
    /**
     * Refers to the specification of service operations supported by the service
     *  interface. At least one operation shall be defined.
     */
    @XmlElement(required = true)
    protected ServiceInterface.Operations operations;
    /**
     * reference to an interface definition that has to be provided by the
     *  service consumer in order to complement the service interface.
     *  Especially if a publish/subscribe service interface is designed, it is
     *  necessary to describe what the service expects to be available on the
     *  subscriber side.
