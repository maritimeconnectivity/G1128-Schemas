 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="requirement" type="{http://iala-aism.org/g1128/v1/ServiceSpecificationSchema.xsd}Requirement" maxOccurs="unbounded"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="serviceDataModel" type="{http://iala-aism.org/g1128/v1/ServiceSpecificationSchema.xsd}ServiceDataModel"/&gt;
 *         &lt;element name="serviceInterfaces"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="serviceInterface" type="{http://iala-aism.org/g1128/v1/ServiceSpecificationSchema.xsd}ServiceInterface" maxOccurs="unbounded"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class ServiceSpecification {
    ...
    /**
     * Globally unique identification of the service. Newer versions of the same
     *  service specification shall not change the id.
     */
    @XmlElement(required = true)
    protected String id;
    /**
     * Version of the service specification. A service specification is uniquely
     *  identified by its id and version. Any change in the service data model or in the
     *  service interface definition requires a new version of the service specification.
     */
    @XmlElement(required = true)
    ...
    /**
     * The human readable service name. The service name shall be at maximum a one
     *  line brief label for the service. Newer versions of the same service
     *  specification shall not change the name.
     */
    @XmlElement(required = true)
    ...
    /**
     * Status of the service specification. One of the values 'provisional', 'released',
     *  'deprecated', 'deleted'.
     */
    @XmlElement(required = true)
    ...
    /**
     * A human readable short description of the service. The description shall contain
     *  an abstract of what a service implementing this specification would actually do.
     */
    @XmlElement(required = true)
    ...
    /**
     * Flag to indicate whether the service shall be "spatial exclusive". "Spatial
     *  exclusiveness" means that at most one service instance of the same service
     *  specification and providing the same technical specification is allowed to be
     *  registered for any geographical area.
     */
    ...
    /**
     * Refers to requirements specifications for the service. Business requirements,
     *  functional and non-functional requirements shall be listed here.
     *  At least one requirement is mandatory.
     */
    @XmlElement(required = true)
    ...
    /**
     * Refers to administrative information about the authors of the service. At least
     *  one author information is mandatory.
     */
    @XmlElement(required = true)
    protected ServiceSpecification.AuthorInfos authorInfos;
    /**
     * Reference to the definition of the logical service data model.
     */
    @XmlElement(required = true)
    protected ServiceDataModel serviceDataModel;
    /**
     * Refers to the definition of service interfaces. At least one service interface
     *  shall be defined.
     */
    @XmlElement(required = true)
    ...
    public static class ServiceInterfaces {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the serviceInterfaces property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         ...
         * 
         * @return list of ServiceInterface
         */
        public List<ServiceInterface> getServiceInterfaces() {
            if (serviceInterfaces == null) {
                serviceInterfaces = new ArrayList<ServiceInterface>();
            }
