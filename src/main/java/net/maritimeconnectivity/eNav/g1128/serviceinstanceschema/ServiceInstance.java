...
import net.maritimeconnectivity.eNav.g1128.servicespecificationschema.ServiceStatus;
import net.maritimeconnectivity.eNav.g1128.servicespecificationschema.VendorInfo;
 ...
 *         &lt;element name="status" type="{http://iala-aism.org/g1128/v1/ServiceSpecificationSchema.xsd}ServiceStatus"/&gt;
 ...
 *         &lt;element name="offersServiceLevel" type="{http://iala-aism.org/g1128/v1/ServiceInstanceSchema.xsd}ServiceLevel"/&gt;
 *         &lt;element name="coversAreas" type="{http://iala-aism.org/g1128/v1/ServiceInstanceSchema.xsd}CoverageInfo"/&gt;
 *         &lt;element name="implementsServiceDesign" type="{http://iala-aism.org/g1128/v1/ServiceInstanceSchema.xsd}ServiceDesignReference"/&gt;
 *         &lt;element name="producedBy" type="{http://iala-aism.org/g1128/v1/ServiceSpecificationSchema.xsd}VendorInfo"/&gt;
 *         &lt;element name="providedBy" type="{http://iala-aism.org/g1128/v1/ServiceSpecificationSchema.xsd}VendorInfo"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ServiceInstance {
    ...
    /**
     * Globally unique identification of the service instance. Newer versions of
     *  the same service instance shall adopt the same id.
     */
    @XmlElement(required = true)
    protected String id;
    /**
     * Version of the service instance. A service specification is uniquely
     *  identified by its id and version. Any change in the service instance data model
     *  or in the service specification reference requires a new version of the
     *  service instance.
     */
    ...
    /**
     * The human readable name of the service instance. The service name shall be
     *  at maximum a one line brief label. Newer versions of the same service
     *  specification shall adopt the same name.
     */
    @XmlElement(required = true)
    ...
    /**
     * Status of the service instance. One of the values 'provisional', 'released',
     *  'deprecated', 'deleted'.
     */
    @XmlElement(required = true)
    ...
    /**
     * A human readable short description of the service instance. The description
     *  shall contain an abstract of what a service implementation actually does.
     */
    @XmlElement(required = true)
    protected String description;
    /**
     * A list of keywords associated to the service.
     */
    @XmlElement(required = true)
    protected String keywords;
    /**
     * Endpoint that describes where the service endpoint is located (e.g. URL)
     */
    @XmlElement(required = true)
    ...
    /**
     * field to categorize the service type. Example: "VIS"
     */
    ...
    /**
     * Refers to the definition of the service level fulfilled by the service instance.
     *  Exactly one service level definition shall be provided.
     */
    @XmlElement(required = true)
    protected ServiceLevel offersServiceLevel;
    /**
     * reference to the geographical area covered by the service instance.
     *  Defines a geographical area from which the service instance is accessible.
     *  This is a choice between a geographical area defined by coordinates or a
     *  United Nations location code (UN/LOCODE). One of the two options has to
     *  be provided. Worldwide accessibility is indicated by a "coversArea" element
    ...
    /**
     * reference to information about the producer of the service
     *  implementation
     */
    @XmlElement(required = true)
    protected VendorInfo producedBy;
    /**
     * reference to information about the service provider of the service
     *  instance.
     */
    @XmlElement(required = true)
